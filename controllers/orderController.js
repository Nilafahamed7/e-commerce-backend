...
//       .populate("products.product", "name imageUrl") // fetch only name & imageUrl
//       .sort({ createdAt: -1 });
...
//       .populate("products.productId", "title price image"); // ensure product populated

//     res.json(orders); // <-- always return an array
//   } catch (err) {
